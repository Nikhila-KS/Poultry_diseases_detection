  ...
  Widget build(BuildContext context) {
    Map<String, Map<String, String>> diseases = {
      ...
      "Salmonella": {
        ...
        "precautions to prevent spread and death of birds": AppLocalizations.of(context)!.sprevent,
        "prevention they should take to not get affected": AppLocalizations.of(context)!.snote,
      },
      "Newcastle_diseases": {
        ...
        "precautions to prevent spread and death of birds": AppLocalizations.of(context)!.nprevent,
        "prevention they should take to not get affected": AppLocalizations.of(context)!.nnote,
      },
      "Coccidiosis": {
        ...
        "precautions to prevent spread and death of birds": AppLocalizations.of(context)!.cprevent,
        "prevention they should take to not get affected":AppLocalizations.of(context)!.cnote,
      },
      "Healthy_poultry": {
        ...
        "precautions to prevent spread and death of birds": AppLocalizations.of(context)!.hprevent,
        "prevention they should take to not get affected": AppLocalizations.of(context)!.hnote,
      }
    };
